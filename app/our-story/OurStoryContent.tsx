        ...
        <div className="inner">
          ...
          <div className="tl">
            ...
            <div className="tl-item r d1">
              <div className="tl-dot">🚀</div>
              <div>
                <div className="tl-year">2025, Platform Launch</div>
                <div className="tl-title">RiseWithJeet becomes a complete UPSC preparation ecosystem</div>
                <div className="tl-body">The platform launches with everything the Telegram community had been asking for: Daily MCQ practice, AI-powered Mains answer evaluation (60-second feedback across 8 parameters), a UPSC-tagged current affairs digest updated every morning at 8 AM, a full syllabus tracker across GS I–IV, adaptive mock tests, and live study rooms for community accountability. Priced at a fair monthly price less than a single coaching module and built with complete pricing transparency. The YouTube community&apos;s 1M+ views become 50,000+ active platform users.</div>
