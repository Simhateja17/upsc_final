...
const PLAN_CARDS: PlanCard[] = [
  {
    ...
    sections: [
      ...
      { text: 'Jeet AI Mentor - 20 lifetime messages, 10/hour throttle' },
  ...
  },
  {
    ...
    sections: [
      ...
      { text: 'Jeet AI Mentor - 5 messages / day' },
  ...
  },
  {
    ...
    sections: [
      ...
      { text: 'Jeet AI Mentor - 25/hour, 100/day' },
  ...
  },
  {
    ...
    sections: [
      ...
      { text: 'Jeet AI Mentor - 50/hour, unlimited/day' },
