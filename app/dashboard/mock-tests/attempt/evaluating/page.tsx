...
// Steps mirror the Jeet AI Evaluation Engine screen used in Daily Mains Challenge.
const STEPS = [
  {
    id: 1,
...
export default function MockTestEvaluatingPage() {
  return (
    <Suspense fallback={
      <div className="h-screen flex items-center justify-center" style={{ background: '#F5F6F8' }}>
