...
type EssayModelAnswerClientProps = {
  questionId?: string;
};

export default function EssayModelAnswerClient({ questionId: providedQuestionId }: EssayModelAnswerClientProps = {}) {
  const params = useParams<{ questionId: string }>();
  const routeQuestionId = Array.isArray(params.questionId) ? params.questionId[0] : params.questionId;
  const questionId = providedQuestionId || routeQuestionId;
