...
const FEATURED_FAQS = [
  ...
  {
    question: 'What is Jeet AI Mentor?',
    answer:
      'Jeet AI Mentor is your personal UPSC AI assistant, available 24/7. Ask it to explain any GS concept, help structure a Mains answer, summarise current affairs, or review your strategy. It is trained on UPSC-specific content, not generic AI.',
  },
  {
