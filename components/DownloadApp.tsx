  ...
  return (
    ...
    >
      ...
      >
        <a
          href="#"
          className="flex items-center gap-2 rounded-xl transition-transform hover:scale-105"
          style={{
            padding: 'clamp(0.6rem, 1vw, 0.85rem) clamp(1.2rem, 2vw, 1.75rem)',
            background: '#1C2E45',
            color: 'white',
          }}
        >
          ...
          <div>
            <div className="font-inter" style={{ fontSize: '0.6rem', opacity: 0.8 }}>Download on the</div>
        ...
        >
          ...
          <div>
            <div className="font-inter" style={{ fontSize: '0.6rem', opacity: 0.8 }}>Get it on</div>
