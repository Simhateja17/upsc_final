    ...
    >
      ...
      >
        <button
          type="button"
          disabled
          className="flex items-center gap-2 rounded-xl bg-[#1C2E45] text-white"
          style={{ padding: 'clamp(0.6rem, 1vw, 0.85rem) clamp(1.2rem, 2vw, 1.75rem)', opacity: 0.75, cursor: 'not-allowed' }}
