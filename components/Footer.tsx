...
function FooterLink({ href, label }: { href: string; label: string }) {
  return (
    <li>
      <Link href={href} className="inline-flex items-center py-1 text-[13px] text-white/60 transition hover:text-white">
        {label}
      </Link>
    </li>
  );
  ...
  return (
    <footer style={{ background: '#060C1C' }}>
      <div className="mx-auto max-w-[1320px] px-5 sm:px-8">
        <div className="mx-6 border-t border-[#F4BF4C]/20" />
        <div className="grid grid-cols-1 gap-8 border-b border-white/[0.04] py-10 md:grid-cols-2 xl:grid-cols-[1.6fr_1fr_1fr_1fr_1.1fr] xl:gap-0">
          <div className="pr-0 xl:pr-8">
            ...
            <div className="mt-3 flex flex-wrap gap-3">
              <a href="https://play.google.com/store/apps/details?id=com.risewithjeet" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-4 py-2 text-[13px] font-semibold text-white transition hover:bg-white/10">
              ...
              <a href="https://apps.apple.com/app/risewithjeet" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-4 py-2 text-[13px] font-semibold text-white transition hover:bg-white/10">
            ...
            <div className="mt-3 flex items-center gap-2">
              <SocialIcon href="https://www.youtube.com/@RisewithJeet" label="YouTube">
              ...
              <SocialIcon href="https://www.instagram.com/risewithjeet" label="Instagram">
              ...
              <SocialIcon href="https://wa.me/918357056891" label="WhatsApp">
              ...
              <SocialIcon href="https://x.com/risewithjeet" label="X">
              ...
              <SocialIcon href="https://www.facebook.com/risewithjeet" label="Facebook">
              ...
              <SocialIcon href="https://www.linkedin.com/company/risewithjeet" label="LinkedIn">
          ...
          <div className="xl:border-l xl:border-white/[0.04] xl:pl-8">
            ...
            <ul className="mt-3 space-y-1">
              {platformLinks.map(([label, href]) => <FooterLink key={href} href={href} label={label} />)}
            </ul>
          </div>
          ...
          <div className="xl:border-l xl:border-white/[0.04] xl:pl-8">
            ...
            <div className="h-[2px] w-7 rounded bg-[#F4BF4C]" />
            <ul className="mt-3 space-y-1">
              {revisionLinks.map(([label, href]) => <FooterLink key={href} href={href} label={label} />)}
            </ul>
          </div>
          ...
          <div className="xl:border-l xl:border-white/[0.04] xl:pl-8">
            ...
            <div className="h-[2px] w-7 rounded bg-[#F4BF4C]" />
            <ul className="mt-3 space-y-1">
              {companyLinks.map(([label, href]) => <FooterLink key={href} href={href} label={label} />)}
            </ul>
          </div>
          ...
          <div className="xl:border-l xl:border-white/[0.04] xl:pl-8">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div>
                ...
                <Link href="/contact" className="mt-1 flex items-center gap-2 text-[13px] text-white/85 transition hover:text-white">
              ...
              <div>
                ...
                <a href="https://wa.me/918357056891" target="_blank" rel="noopener noreferrer" className="mt-1 flex items-center gap-2 text-[13px] text-white/85 transition hover:text-white">
                  <Image src="/msggg.png" alt="WhatsApp" width={16} height={16} style={{ objectFit: 'contain' }} />
                  +91 83570 56891
                </a>
                <a href="https://wa.me/918357056891" target="_blank" rel="noopener noreferrer" className="mt-2 inline-flex items-center gap-1.5 rounded-full border border-[#25D366]/35 bg-[#25D366]/12 px-3 py-1 text-[11px] font-semibold text-[#4ADE80] transition hover:bg-[#25D366]/20">
              ...
              <div>
                ...
                <a href="https://t.me/togetherrisewithjeet" target="_blank" rel="noopener noreferrer" className="mt-1 flex items-center gap-2 text-[13px] text-white/85 transition hover:text-white">
                  <Image src="/pooOO.png" alt="Telegram" width={16} height={16} style={{ objectFit: 'contain' }} />
                  @togetherrisewithjeet
                </a>
                <a href="https://t.me/risewithjeet" target="_blank" rel="noopener noreferrer" className="mt-2 inline-flex items-center gap-1.5 rounded-full border border-[#38BDF8]/35 bg-[#38BDF8]/12 px-3 py-1 text-[11px] font-semibold text-[#7DD3FC] transition hover:bg-[#38BDF8]/20">
